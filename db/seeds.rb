...
Skill.create(name: "violin", category: "musical instrument", description: "Learn to play the violin", signed_up: false, video_url: "", user_id: User.first.id)
...
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.first.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.first.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.first.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.first.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.second.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.second.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.second.id)
Skill.create(name: Faker::Job.key_skill, category: Faker::Job.field, description: Faker::Company.catch_phrase, signed_up: false, video_url: Faker::Company.logo, user_id: User.second.id)
